...
1. `git clone https://github.com/Artieficr/source-ingest` and `git checkout 8cbf8d1` to grab fresh state, without examples (or skip `checkout` if you want to keep them).
