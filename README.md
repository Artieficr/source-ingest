...
1. `git clone https://github.com/Artieficr/source-ingest` and `git checkout aba0b59` to grab fresh state, without examples (or skip `checkout` if you want to keep them).
